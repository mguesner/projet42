...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   print_img_my_player_view_human.c                   :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mdarty <mdarty@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/06/24 07:25:51 by mdarty            #+#    #+#             */
/*   Updated: 2014/06/24 07:25:52 by mdarty           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void st_print_my_player_cur(t_env *e, t_player *player, int x, int y)
{
	if (player->view == VIEW_NORTH)
		ft_print_img(e, OBJ_V_NORTH_CUR.ptr, x, y);
	else if (player->view == VIEW_EAST)
		ft_print_img(e, OBJ_V_EAST_CUR.ptr, x, y);
	else if (player->view == VIEW_SOUTH)
		ft_print_img(e, OBJ_V_SOUTH_CUR.ptr, x, y);
	else
		ft_print_img(e, OBJ_V_WEST_CUR.ptr, x, y);
}

static void st_print_my_player_free(t_env *e, t_player *player, int x, int y)
{
	if (player->view == VIEW_NORTH)
		ft_print_img(e, OBJ_V_NORTH_FREE.ptr, x, y);
	else if (player->view == VIEW_EAST)
		ft_print_img(e, OBJ_V_EAST_FREE.ptr, x, y);
	else if (player->view == VIEW_SOUTH)
		ft_print_img(e, OBJ_V_SOUTH_FREE.ptr, x, y);
	else
		ft_print_img(e, OBJ_V_WEST_FREE.ptr, x, y);
}

static void st_print_my_player_ot(t_env *e, t_player *player, int x, int y)
{
	if (player->view == VIEW_NORTH)
		ft_print_img(e, OBJ_V_NORTH_OT.ptr, x, y);
	else if (player->view == VIEW_EAST)
		ft_print_img(e, OBJ_V_EAST_OT.ptr, x, y);
	else if (player->view == VIEW_SOUTH)
		ft_print_img(e, OBJ_V_SOUTH_OT.ptr, x, y);
	else
		ft_print_img(e, OBJ_V_WEST_OT.ptr, x, y);
}
...
void		ft_print_img_my_player_view(t_env *e, t_case *field, int x, int y)
{
