...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   print_img_my_player_void_human.c                   :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mdarty <mdarty@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/06/24 07:26:00 by mdarty            #+#    #+#             */
/*   Updated: 2014/06/24 07:26:02 by mdarty           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void st_print_my_player_cur(t_env *e, t_player *player, int x, int y)
{
	if (player->view == VIEW_NORTH)
		ft_print_img(e, OBJ_VOID_NORTH_CUR.ptr, x, y);
	else if (player->view == VIEW_EAST)
		ft_print_img(e, OBJ_VOID_EAST_CUR.ptr, x, y);
	else if (player->view == VIEW_SOUTH)
		ft_print_img(e, OBJ_VOID_SOUTH_CUR.ptr, x, y);
	else
		ft_print_img(e, OBJ_VOID_WEST_CUR.ptr, x, y);
}

static void st_print_my_player_free(t_env *e, t_player *player, int x, int y)
{
	if (player->view == VIEW_NORTH)
		ft_print_img(e, OBJ_VOID_NORTH_FREE.ptr, x, y);
	else if (player->view == VIEW_EAST)
		ft_print_img(e, OBJ_VOID_EAST_FREE.ptr, x, y);
	else if (player->view == VIEW_SOUTH)
		ft_print_img(e, OBJ_VOID_SOUTH_FREE.ptr, x, y);
	else
		ft_print_img(e, OBJ_VOID_WEST_FREE.ptr, x, y);
}

static void st_print_my_player_ot(t_env *e, t_player *player, int x, int y)
{
	if (player->view == VIEW_NORTH)
		ft_print_img(e, OBJ_VOID_NORTH_OT.ptr, x, y);
	else if (player->view == VIEW_EAST)
		ft_print_img(e, OBJ_VOID_EAST_OT.ptr, x, y);
	else if (player->view == VIEW_SOUTH)
		ft_print_img(e, OBJ_VOID_SOUTH_OT.ptr, x, y);
	else
		ft_print_img(e, OBJ_VOID_WEST_OT.ptr, x, y);
}
...
void		ft_print_img_my_player_void(t_env *e, t_case *field, int x, int y)
{
